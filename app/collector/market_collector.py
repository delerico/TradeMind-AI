...
class MarketCollector:
    ...
    def __init__(self, yfinance_module: Any = yf) -> None:
        ...
        Args:
            yfinance_module: module or object exposing a `Ticker(symbol)`
                interface compatible with yfinance. Defaults to the real
                yfinance module; overridable for unit testing.
        """
    ...
    def get_stock(self, symbol: str, period: str = "1mo") -> pd.DataFrame:
        ...
        Args:
            ...
            period: yfinance-compatible period, e.g. "1d", "5d", "1mo",
                "3mo", "6mo", "1y", "5y", "max". Defaults to "1mo".

        Returns:
            pandas.DataFrame indexed by date, containing the columns
            Open, High, Low, Close, Volume.

        Raises:
            ValueError: If `symbol` or `period` is empty.
            MarketDataError: If the data cannot be retrieved, is empty,
        ...
        return raw_data[list(self._REQUIRED_COLUMNS)]
